...
const PROMPT =
  ...
  '{"asking_price": number, "floor_price": number, "reasoning": string}. ' +
  "asking_price is a realistic local-pickup asking price in USD. floor_price is " +
  "the least a seller should accept, strictly below asking_price. Both are whole " +
  "dollars. Be realistic for a used item sold locally, not retail.";
